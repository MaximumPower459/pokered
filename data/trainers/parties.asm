...
KogaData:
	db $FF, 37, VENOMOTH, 39, MUK, 37, GOLBAT, 43, WEEZING, 0

BlaineData:
	db $FF, 42, RAPIDASH, 40, FLAREON, 42, MAGMAR, 47, ARCANINE, 0

SabrinaData:
	db $FF, 38, HAUNTER, 37, MR_MIME, 38, JYNX, 43, ALAKAZAM, 0
...
Green2Data:
; SS Anne 2F
	db $FF, 19, PIDGEOTTO, 16, RATICATE, 18, MACHOKE, 20, WARTORTLE, 0
	db $FF, 19, PIDGEOTTO, 16, RATICATE, 18, MACHOKE, 20, IVYSAUR, 0
	db $FF, 19, PIDGEOTTO, 16, RATICATE, 18, MACHOKE, 20, CHARMELEON, 0
; Pok̩mon Tower 2F
	db $FF, 25, PIDGEOTTO, 23, GROWLITHE, 22, EXEGGCUTE, 20, MACHOKE, 25, WARTORTLE, 0
	db $FF, 25, PIDGEOTTO, 23, GYARADOS, 22, GROWLITHE, 20, MACHOKE, 25, IVYSAUR, 0
	db $FF, 25, PIDGEOTTO, 23, EXEGGCUTE, 22, GYARADOS, 20, MACHOKE, 25, CHARMELEON, 0
; Silph Co. 7F
	db $FF, 37, PIDGEOT, 38, GROWLITHE, 35, EXEGGCUTE, 35, MACHAMP, 40, BLASTOISE, 0
	db $FF, 37, PIDGEOT, 38, GYARADOS, 35, GROWLITHE, 35, MACHAMP, 40, VENUSAUR, 0
	db $FF, 37, PIDGEOT, 38, EXEGGCUTE, 35, GYARADOS, 35, MACHAMP, 40, CHARIZARD, 0
; Route 22
	db $FF, 47, PIDGEOT, 45, RHYHORN, 45, GROWLITHE, 47, EXEGGCUTE, 50, MACHAMP, 53, BLASTOISE, 0
	db $FF, 47, PIDGEOT, 45, RHYHORN, 45, GYARADOS, 47, GROWLITHE, 50, MACHAMP, 53, VENUSAUR, 0
	db $FF, 47, PIDGEOT, 45, RHYHORN, 45, EXEGGCUTE, 47, GYARADOS, 50, MACHAMP, 53, CHARIZARD, 0

Green3Data:
	db $FF, 61, PIDGEOT, 59, MACHAMP, 61, RHYDON, 61, ARCANINE, 63, EXEGGUTOR, 65, BLASTOISE, 0
	db $FF, 61, PIDGEOT, 59, MACHAMP, 61, RHYDON, 61, GYARADOS, 63, ARCANINE, 65, VENUSAUR, 0
	db $FF, 61, PIDGEOT, 59, MACHAMP, 61, RHYDON, 61, EXEGGUTOR, 63, GYARADOS, 65, CHARIZARD, 0
...
LanceData:
	db $FF, 58, GYARADOS, 56, SEADRA, 56, CHARIZARD, 60, AERODACTYL, 62, DRAGONITE, 0
